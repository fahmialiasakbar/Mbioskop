/**
 * Created by Fahmi Akbar on 13/06/2017.
 */
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static String DATABASE_NAME = "db_film";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "(" + KEY1 + "INTEGER PRIMARY KEY," + KEY2 + "VARCHAR(70)," + KEY3 + "VARCHAR(200)" + ")";
